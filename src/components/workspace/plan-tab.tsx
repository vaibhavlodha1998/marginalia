  ...
  return (
    <div className="mx-auto max-w-[680px] p-10 max-md:p-6">
      ...
      <p className="mb-7 text-[14.5px] text-ink-2">
        Your objectives for this lesson. Tap a completed or current one to jump
        to it — upcoming ones unlock as you go.
      </p>
        ...
        {sections.map((section) => (
          <div key={section.title}>
            ...
            <div className="flex flex-col gap-3">
              {section.items.map((o) => {
                const clickable = o.status === "done" || o.status === "current";
                return (
                  <button
                    key={o.id}
                    type="button"
                    ...
                    className={cn(
                      "flex items-center gap-4 rounded-[12px] border border-border bg-surface px-[18px] py-4 text-left transition-colors",
                      clickable
                  ...
                  >
                    <div
                      className={cn(
                        "flex size-[34px] flex-none items-center justify-center rounded-full border-[1.5px] font-serif text-[13px] font-semibold",
                        o.status === "done"
