  ...
  return (
    <div className="group relative">
      ...
      <Link
        ...
        className="block rounded-[14px] border border-border bg-surface p-[22px] transition hover:-translate-y-0.5 hover:border-border-muted hover:shadow-[0_12px_28px_rgba(44,39,34,0.09)]"
      >
        <div className="flex items-start justify-between gap-3">
          ...
          <span className="text-[11.5px] font-semibold uppercase tracking-[0.04em] text-ink-3 transition-opacity group-hover:opacity-0">
