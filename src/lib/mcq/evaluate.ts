...
const RUBRICS: Record<EvaluatorKind, string> = {
  ...
  quality:
    "Check the question is clear, non-trivial, on-topic for the objective, and the hint does NOT reveal the answer. Fail if trivial, off-topic, or the hint spoils the answer.",
};
